...
class ImageClassificationParams(AutoTrainParams):
    ...
    warmup_epochs: int = Field(5, title="Warmup Epochs (Linear Probe)")
    augment_prob: float = Field(0.5, title="Probability of Heavy Color Jitter")
    grayscale_prob: float = Field(0.2, title="Probability of Random Grayscale")
    ...
    augment_hue: float = Field(0.1, title="Hue Shift Strength")
    augment_horizontal_flip_prob: float = Field(0.5, title="Horizontal Flip Probability")
    augment_rotate_prob: float = Field(0.5, title="Random Rotate 90 Probability")
    cutout_max_holes: int = Field(8, title="Cutout Max Holes")
    cutout_max_height_ratio: float = Field(0.125, title="Cutout Max Height Ratio")
    cutout_max_width_ratio: float = Field(0.125, title="Cutout Max Width Ratio")
